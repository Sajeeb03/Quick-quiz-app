            ...
            <header className="p-4 bg-gray-800 text-gray-100">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch hidden space-x-3 md:flex">
                        ...
                        <li className="flex">
                            <Link rel="noopener noreferrer" to='/statistics' className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-violet-400 border-violet-400">Statistics</Link>
                        </li>
                        <li className="flex">
